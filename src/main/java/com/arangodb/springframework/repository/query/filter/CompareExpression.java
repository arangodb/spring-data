...
public class CompareExpression extends AbstractExpression {
    ...
    public CompareExpression(Comparator comparator, Field left, String right) {
    ...
    public String toString() {
        String escapedRight = String.format("\"%s\"", right);
        return String.format("%s %s %s", left, comparator, escapedRight);
    }
